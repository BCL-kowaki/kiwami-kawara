...
import { CryptoData, CryptoDetail } from "@/types/portfolio";
...
export default function CryptoCategory({ data, onChange }: CryptoCategoryProps) {
  const addDetailRow = () => {
  ...
  const updateDetailRow = (index: number, row: CryptoDetail) => {

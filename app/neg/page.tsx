          ...
          <div className="backdrop-blur-sm rounded-[2px] p-4" style={cardStyle}>
            <div className="text-center mb-4">
              ...
              <p className="text-xs mt-3 leading-relaxed text-left text-white whitespace-pre-line">
                {step === "form" &&
                  "本音を教えてください。「相場系投資って疲れませんか？」日々の価格変動やニュース、SNSの情報に振り回され、「いつ売買すべきか分からない」「思うように成果が出ない」「含み損に不安を感じる」と感じながら、、、。\n\n本来見極めるべき“投資そのものの構造”を見落として自分でも気づいていない大きなリスクを抱えてしまっているケースも少なくありません。\n\nそこで今回、KAWARA版では、相場に依存しない“非相場系投資”に関する情報配信サービスを開始しました。\n\nまだ情報を受け取っていない方は、この機会にぜひご確認ください。以下をご入力のうえ、注意事項に同意のうえお申し込みください。"
                }
                {step === "phone" &&

          ...
          <div className="backdrop-blur-sm rounded-[2px] p-4" style={cardStyle}>
            <div className="text-center mb-4">
              ...
              {step === "form" && (
                ...
                >
                  時価総額300億円から&ldquo;10倍&rdquo;へ。<br />精密AI&ldquo;極&rdquo;が特定した、<br />次のテンバガー有望銘柄とは？
                </h1>
              )}
              {/* コピー */}
              <p className="text-xs mt-3 leading-relaxed text-left text-white">
                {step === "form" &&
                  "「テンバガー（10倍株）」は、企業が研究段階から商用化へと移る“分水嶺”で生まれます。SNSや経済誌などで語られる幾多もの俗説の中から「構造だけ」を“AI極”が冷徹に解剖し、時価総額300億円規模から10倍を狙える有望銘柄を1社に絞り込みました。まだ当レポートの内容を確認していない方は、今すぐお受け取りください。以下をご入力のうえ、免責事項に同意してお申し込みください。"
                }
                {step === "phone" &&

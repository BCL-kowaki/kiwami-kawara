            ...
            <div className="min-h-screen flex items-center justify-center p-4" style={{ background: 'linear-gradient(135deg, #020617 0%, #0a1628 50%, #020617 100%)' }}>
                <div className="bg-white/95 backdrop-blur-sm rounded-[2px] shadow-2xl p-5 max-w-md w-full text-center border border-white/20 animate-fade-in">
                    <div className="mb-2 pt-6 pb-4">
                        <div className="inline-flex items-center justify-center w-15 h-15 rounded-full shadow-lg animate-bounce" style={{ background: 'linear-gradient(135deg, #FFD700 0%, #D4AF37 50%, #B8860B 100%)' }}>
                            <svg
                                className="w-10 h-10"
                                fill="none"
                                stroke="currentColor"
                    ...
                    <h1 className="text-xl font-extrabold bg-clip-text text-transparent mb-4" style={{ background: 'linear-gradient(135deg, #FFD700 0%, #D4AF37 50%, #B8860B 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
                        ご入力ありがとうございました
                    </h1>
    ...
    return (
        ...
        >
            ...
            <div className="max-w-[640px] mx-auto relative z-10">
                <div className="p-[2px] rounded-[2px] shadow-2xl mb-6" style={{ background: 'linear-gradient(135deg, #FFD700 0%, #D4AF37 50%, #B8860B 100%)' }}>
                <div className="backdrop-blur-sm rounded-[2px] p-4" style={{ background: 'linear-gradient(135deg, #0f0f0f 0%, #1a1a1a 50%, #0f0f0f 100%)' }}>
                    <div className="text-center mb-4">
                        <div className="inline-block mb-4">
                            <div className="w-16 h-16 rounded-[2px] flex items-center justify-center mx-auto shadow-lg" style={{ background: 'linear-gradient(135deg, #FFD700 0%, #D4AF37 50%, #B8860B 100%)' }}>
                                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                                </svg>
                            </div>
                        </div>
                        <h1 className="text-2xl mb-3" style={{ background: 'linear-gradient(135deg, #FFD700 0%, #D4AF37 50%, #B8860B 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text', fontWeight: 900 }}>
                            超精密！<br />
                            資産運用AI分析"極"
                        </h1>
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                        <input
                                            ...
                                            required
                                            className="w-full px-4 py-3 rounded-[2px] focus:ring-2 focus:ring-yellow-500 transition-all placeholder-gray-400"
                        ...
                        <div className="mt-6 mb-6">
                            ...
                            <div className="flex justify-center">
                                <button
                                    ...
                                    style={formState !== "submitting" ? { background: 'linear-gradient(135deg, #FFD700 0%, #D4AF37 50%, #B8860B 100%)', color: '#1a1a1a' } : {}}
                                >

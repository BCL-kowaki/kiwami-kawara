        ...
        <div className="p-[2px] rounded-[2px] shadow-2xl mb-6" style={borderStyle}>
          <div className="backdrop-blur-sm rounded-[2px] p-4" style={cardStyle}>
            <div className="text-center mb-4">
              ...
              <h1 className="text-3xl sm:text-5xl mb-4 mt-2 leading-tight" style={{ fontWeight: 900, background: "linear-gradient(90deg, #ff8fa9 0%, #f773b8 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>
              ...
              <div className="text-base mt-3 leading-relaxed text-left" style={{ color: "#e0e0e0" }}>
                {step === "form" && (
                  <>
                    ...
                    <p className="mt-4" style={{ background: "linear-gradient(90deg, #ff8fa9 0%, #f773b8 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text", fontWeight: 700 }}>こんなことを考えている人だらけです。</p>
